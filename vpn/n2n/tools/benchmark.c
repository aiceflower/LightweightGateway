...
int main(int argc, char * argv[]) {
  ...
  n2n_transop_wbsm4_init(&conf, &transop_wbsm4);
  ...
  run_transop_benchmark("transop_wbsm4", &transop_wbsm4, &conf, pktbuf);
  ...
  transop_wbsm4.deinit(&transop_wbsm4);
  return 0;
}
